...
public class FindGuitarTest {
	...
	private static void initializeInventory(Inventory inventory) {
		...
		inventory.addGuitar("11277", 3999.95, Builder.COLLINGS, "CJ", Type.ACOUSTIC, Wood.INDIAN_ROSEWOOD, Wood.STIKA);
		...
		inventory.addGuitar("566-62", 8999.95, Builder.RYAN,  "Cathedral", Type.ACOUSTIC,Wood.COCBOLO, Wood.CEDAR);
